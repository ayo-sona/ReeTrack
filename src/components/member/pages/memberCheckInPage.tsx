...
import { Clock, CheckCircle, Calendar, QrCode, RefreshCw, Search, X } from "lucide-react";
          ...
          <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={1}>
            {checkInCode ? (
              ...
              <div style={{
                ...
                background: C.teal, borderRadius: "24px",
              }}
              ...
              >
                ...
                <div style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
                  ...
                  <div
                    ...
                    style={{ display: "flex", gap: "12px", justifyContent: "center", marginTop: "40px" }}
                  >
                    <Button
                      variant="outline"
                      size="lg"
                      onClick={() => { setCheckInCode(null); handleGenerateCode(); }}
              ...
              <div style={{ position: "relative", marginBottom: "16px" }}>
                <Search
                  ...
                  style={{
                    ...
                    color: C.coolGrey, pointerEvents: "none",
                  }}
                />
                <input
                  type="text"
                ...
                {searchQuery && (
                  <button
                    ...
                    style={{
                      ...
                      color: C.coolGrey, display: "flex", alignItems: "center", padding: "2px",
                    }}
                  >
                    <X size={14} />
                  </button>
                  ...
                  {filteredCheckIns.map((record) => (
                    ...
                    >
                      <div>
                        ...
                        <p style={{ fontWeight: 400, fontSize: "12px", color: C.coolGrey }}>{record.time} · {record.location}</p>
                      </div>
                      <span style={{
                        fontSize: "11px", fontWeight: 700, padding: "4px 10px", borderRadius: "999px",
                        background: record.status === "approved" ? "rgba(13,148,136,0.1)" : record.status === "denied" ? "rgba(240,101,67,0.1)" : "rgba(156,163,175,0.15)",
                        color: record.status === "approved" ? C.teal : record.status === "denied" ? C.coral : C.coolGrey,
