        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {organizations.map((org, i) => (
            ...
            >
              <OrgCard
                org={org}
                onSelect={() => handleOrgClick(org.id, org.member)}
              />
            </motion.div>
          ))}
        </div>
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 600, color: C.coolGrey }}>
            View rankings
          </span>
        </div>
      </div>
      ...
      <div
        style={{
          ...
          height: 32,
          borderRadius: 8,
          background: hovered ? "rgba(13,148,136,0.08)" : C.snow,
          border: `1px solid ${hovered ? "rgba(13,148,136,0.2)" : C.border}`,
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          flexShrink: 0,
