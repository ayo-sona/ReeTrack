...
import { Share2, Copy, Check, QrCode, Mail, MessageCircle, Facebook, Twitter, Gift, Users, TrendingUp } from 'lucide-react';
...
export default function ReferralsPage() {
  ...
  const handleShare = (platform: string) => {
    ...
    const text = `Join me on PayPips and get ₦2,500 off your first subscription! Use my code: ${referral?.code}`;
    ...
    switch (platform) {
      ...
      case 'twitter':
        ...
        break;
      case 'email':
        window.open(`mailto:?subject=Join me on PayPips&body=${encodeURIComponent(text + '\n\n' + url)}`);
        break;
    }
  };
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-3xl font-bold text-gray-900">{referral?.referredMembers || 0}</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-3xl font-bold text-gray-900">₦{referral?.totalEarnings.toLocaleString() || 0}</p>
          </div>
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl p-8 text-white shadow-xl">
          <div className="text-center mb-8">
            ...
            <p className="text-emerald-100">Share this code with friends and family</p>
          </div>

          {/* Code Display */}
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 mb-6">
            <div className="flex items-center justify-between mb-4">
              <span className="text-4xl font-mono font-bold tracking-wider">{referral?.code}</span>
              <button
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Send your referral code to friends via WhatsApp, email, or social media</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Your friend creates an account and subscribes to a plan</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Get ₦2,500 credited to your wallet for each successful referral</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold text-gray-900">Referred Members</h3>
            <span className="text-sm text-gray-600">{referredMembers?.length || 0} total</span>
          </div>
          ...
          {referredMembers && referredMembers.length > 0 ? (
              ...
              {referredMembers.map((member) => (
                <div key={member.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-emerald-600">+₦{member.reward.toLocaleString()}</p>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">Start sharing your code to earn rewards</p>
              <button
                onClick={() => handleCopy(referral?.shareUrl || '')}
          ...
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setShowQR(false)}>
            <div className="bg-white rounded-2xl p-8 max-w-sm w-full" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="w-64 h-64 mx-auto bg-gray-100 rounded-xl flex items-center justify-center mb-4">
                {referral?.qrCode ? (
                  <img src={referral.qrCode} alt="QR Code" className="w-full h-full" />
                ) : (
                  <QrCode className="w-32 h-32 text-gray-400" />
                )}
              </div>
              <p className="text-center text-gray-600 mb-6">Share this QR code for easy sign-ups</p>
              <button
