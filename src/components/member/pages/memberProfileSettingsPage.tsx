    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
      ...
      <input
        ...
        style={{
          ...
          boxShadow:
            focused && !disabled ? "0 0 0 3px rgba(13,148,136,0.12)" : "none",
          background: disabled ? C.snow : C.white,
          fontFamily: "Nunito, sans-serif",
          fontWeight: 400,
          fontSize: "14px",
          color: disabled ? C.coolGrey : C.ink,
          outline: "none",
        ...
        <AnimatePresence>
          {showSuccess && (
            ...
            >
              ...
              <p style={{ fontWeight: 600, fontSize: "14px", color: C.teal }}>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="fields-grid-editable">
                      <Field
                        label="Date of Birth"
                        hint="Required for age-restricted subscriptions"
                        value={dateOfBirth}
                    ...
                    <div
                      style={{
                        ...
                        padding: "10px 16px",
                        borderRadius: "8px",
                        background: actualProfile.email_verified
                          ? "rgba(13,148,136,0.08)"
                          : "rgba(251,191,36,0.1)",
                        border: `1px solid ${actualProfile.email_verified ? "rgba(13,148,136,0.2)" : "rgba(251,191,36,0.25)"}`,
                      }}
                    >
                      ...
                      <span
                        style={{
                          fontWeight: 600,
                          fontSize: "13px",
                          color: actualProfile.email_verified
                            ? C.teal
                            : "#D97706",
                        }}
                      >
                      ...
                      {[
                        {
                          ...
                          value: actualProfile.status || "Active",
                        },
                        {
                          label: "Last Login",
                          value: actualProfile.last_login_at
                            ? new Date(
